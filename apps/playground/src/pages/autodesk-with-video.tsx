import { LauncherFacade, Room, VideoConference, ParticipantType } from "../lib/sdk";
import { v4 as generateId } from "uuid";
import { Presence3D } from "../lib/autodesk";
...
const componentName = "autodesk-with-video";

export function AutodeskWithVideo() {
  ...
  const initializeSuperViz = useCallback(async () => {
    ...
    const video = new VideoConference({
      userType: type as ParticipantType,
    });
