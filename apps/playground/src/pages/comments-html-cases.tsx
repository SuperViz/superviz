import { Comments, HTMLPin, LauncherFacade, Room } from "../lib/sdk";
...
const componentName = "comments-html-cases";
...
export function CommentsHtmlCases() {
  ...
  const initializeSuperViz = useCallback(async () => {
    ...
    room.current.addComponent(comments);
  }, []);
