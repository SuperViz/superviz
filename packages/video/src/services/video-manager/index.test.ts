...
const MOCK_LOCAL_PARTICIPANT: Participant = {
  id: '1',
  name: 'Alice',
  activeComponents: [],
  avatar: {
    imageUrl: 'https://unit-test-avatar-url/',
    model3DUrl: 'https://unit-test-model-3d-url/',
  },
  email: '',
  slot: {} as Slot,
...
describe('VideoConferenceManager', () => {
  ...
  describe('onParticipantLeft', () => {
    test('should publish the left participant', () => {
      const participant: Participant = { id: '1', name: 'Alice' } as Participant;
